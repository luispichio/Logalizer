...
sudo apt install build-essential cmake ninja-build qt6-base-dev qt6-tools-dev qt6-tools-dev-tools libqt6sql6-sqlite libgl1-mesa-dev wget file libfuse2
